...
/// if you want to create an element for each player, you can use the <see cref="AutoElement(Roles, Func{TResult})"/>
/// constructor.
/// </remarks>
public class AutoElement
{
    ...
    internal virtual void GiveTo(DisplayCore core)
    {
        if (element != null)
        {
    ...
    /// </summary>
    /// <param name="core">The <see cref="DisplayCore"/> to give to.</param>
    internal virtual void RemoveFrom(DisplayCore core)
    {
