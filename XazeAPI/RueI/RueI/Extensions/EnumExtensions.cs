...
public static class EnumExtensions
{
    ...
    /// </remarks>
    public static bool HasFlagFast(this Roles first, Roles second) => second.roles.All(role => first.Has(role));
    ...
    public static bool HasFlagFast(this Displays.Roles first, RoleTypeId second)
    {
        ...
        Displays.Roles secondCasted = (Displays.Roles)(1 << (int)second);
